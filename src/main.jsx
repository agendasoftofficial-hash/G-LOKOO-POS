  ...
  return <div className="app">
    ...
    <main className="main">
      <header className="topbar">
        ...
        <div className="top-actions"><button><Bell size={19}/></button><div className="user"><ShieldCheck size={14}/>{profile?.full_name||session.user.email}<small>{role}</small></div><button className="logout-btn" onClick={logout} title="Log out"><LogOut size={18}/><span>Logout</span></button></div>
      </header>
  ...
  return <section className="content">
    ...
    <div className="settings-grid">
      ...
      <div className="panel settings-card">
        ...
        <div className="settings-fixed-row"><span>Currency</span><strong>GHS Â· \u20B5</strong></div>
